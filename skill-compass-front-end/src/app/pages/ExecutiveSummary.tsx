  ...
  return (
    <div className="dashboard-page" style={{ flex: 1, background: colors.lightBg, display: "flex", flexDirection: "column", overflow: "hidden" }}>
      <SlicerBar>
        ...
        <div className="filter-result-count" style={{ marginLeft: "auto", fontSize: 10, color: colors.medGrey }}>
      ...
      <div className="page-content" style={{ flex: 1, padding: "10px 16px", display: "flex", flexDirection: "column", gap: 10, overflow: "hidden" }}>
        <div className="kpi-grid executive-kpis" style={{ display: "flex", gap: 10, flexShrink: 0 }}>
        ...
        <div className="chart-grid executive-grid" style={{ flex: 1, display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gridTemplateRows: "1fr 1fr", gap: 10, overflow: "hidden" }}>
